...
@connect(({ global, loading }) => ({
  global,
  loading: loading.effects['global/fetch_getFileBounceList'],
}))
class bounce extends PureComponent {
  state = {};
  ...
  render() {
    const { global: { bounce_list }, loading } = this.props;
    const columns = [
      {
        title: '标题',
        dataIndex: 'title',
      ...
      //   dataIndex: 'entTime',
      //   key: 'entTime',
      //   render: val => <Paragraph ellipsis>{val}</Paragraph>,
      // },
    ];
