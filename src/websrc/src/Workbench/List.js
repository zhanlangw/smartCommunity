...
class List extends Component {
  ...
  render() {
    const {
      global: { bounce_list, delayed_list, disposal_list, inspect_list, event_list },
                ...
                >
                  ...
                  <Row span={24}>
                    ...
                    <Col span={1} style={{marginTop: "16%"}}>
                      <Icon type="right-circle" style={{ fontSize: 40, lineHeight: 10, height: 200, float: 'right' }} onClick={this.next} />
                      <Col span={2} offset={5}>
                              (
                                  <div
