...
class List extends PureComponent {
  ...
  getList = payload => {
    const { dispatch, type, pageStatus } = this.props;
    console.log(type);
    console.log(payload);
  ...
  handleClickDel = () => {
    const { dispatch, type, delButton, smallId } = this.props;
    let id = smallId && smallId || null;
  ...
  DrawerForm = () => {
    ...
    switch (type) {
      case 'station/fetch_getStationList':
        return (
          <Form>
            <Form.Item
              label='名称'
      ...
      case 'blacklist/fetch_getBlacklistList':
        return (
          <Form>
            <Form.Item
              label='名称'
      ...
      case 'device/fetch_getDeviceList':
        return (
          <Form>
            <Form.Item
              label='名称'
            ...
            >
              {getFieldDecorator('unitName', {})(
                <Input placeholder='请输入组织机构名' />
              )}
            </Form.Item>
          </Form>
        );
      case 'event/fetch_getFileEventList':
        return (
          <Form>
            <Form.Item
              label='名称'
  ...
  render() {
    const { dataSource, columns, filter } = this.props;
    const { visible, loading, selectedRowKeys, start } = this.state;
    const rowSelection = {
              ...
              <Row type="flex">
                ...
                <div style={{ marginTop: 5 }}>
                  ...
                  <Text
                    ...
                    style={filter ? { fontSize: 16, cursor: 'pointer', marginLeft: 18 } : { fontSize: 16, cursor: 'pointer' }}
                  >
                    重置
                  </Text>
                </div>
