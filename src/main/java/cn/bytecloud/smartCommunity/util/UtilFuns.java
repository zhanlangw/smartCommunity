    ...
    */
    ...
    public static String htmlNewline(String s) {
        try {
            ...
            //s.replaceAll(" ","&nbsp;") 不能进行空格的替换，否则页面内容中如果有<img src="xxx.jpg" \>等标签，内容就会显示乱；<img&nbsp;src="xxx
            // .jpg"nbsp;\>
...
//
//
//	  java.util.List aList = news ArrayList();
...
//	  }
    ...
    */
		...
		StringBuffer sBuffer = news StringBuffer();
...
/*
    ...
    public String htmlReplaceAll(String s) {
        try {
            ...
            sBuf.append(s.replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\"",
                    "&quot;").replaceAll("\n", "<br\\>"));
            return sBuf.toString();
        } catch (Exception e) {
            return "";
